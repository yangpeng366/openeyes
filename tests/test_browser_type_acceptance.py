"""Tests for the direct MCP stdio browser_type acceptance probe."""
...
PROBE = ROOT / "examples" / "browser-type-acceptance.py"


def test_type_acceptance_boots_mcp_and_keeps_type_dry_run():
...
def test_type_acceptance_result_content_parses_single_text_payload():
    spec = importlib.util.spec_from_file_location(
        "browser_type_acceptance", PROBE,
    )
...
def test_type_acceptance_checks_would_send_chars_and_resolved_target():
    text = PROBE.read_text(encoding="utf-8")
